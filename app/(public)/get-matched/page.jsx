...
const PATHS = [
  {
    ...
    color: "text-[#2d6a4f]",
    fields: [
      { name: "name", label: "Your name", placeholder: "Alex Johnson", required: true },
      { name: "email", label: "Email", placeholder: "alex@fund.com", required: true, type: "email" },
  ...
  },
  {
    ...
    fields: [
      { name: "name", label: "Your name", placeholder: "Alex Johnson", required: true },
      { name: "email", label: "Email", placeholder: "alex@company.com", required: true, type: "email" },
  ...
  },
  {
    ...
    fields: [
      { name: "name", label: "Your name", placeholder: "Alex Johnson", required: true },
      { name: "email", label: "Email", placeholder: "alex@consulting.com", required: true, type: "email" },
      { name: "linkedin", label: "LinkedIn URL", placeholder: "https://linkedin.com/in/alexjohnson", required: false },
