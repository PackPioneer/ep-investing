    ...
    <div className="min-h-screen bg-[#f2f4f8]" style={{ fontFamily: "var(--font-geist-sans), sans-serif" }}>
      <div className="max-w-3xl mx-auto px-6 py-20">
        <div className="mb-12">
          ...
          <h1 style={{ fontFamily: 'var(--font-display), sans-serif' }} className="text-4xl text-[#0f1a14] mb-4">Disclaimer</h1>
        ...
        <div className="flex flex-col gap-8 text-[#4a5568] text-sm leading-relaxed">
          ...
          <div className="bg-white border border-[#e2e6ed] rounded-2xl p-8">
            <h2 style={{ fontFamily: 'var(--font-display), sans-serif' }} className="text-xl text-[#0f1a14] mb-4">Not financial advice</h2>
          ...
          <div className="bg-white border border-[#e2e6ed] rounded-2xl p-8">
            <h2 style={{ fontFamily: 'var(--font-display), sans-serif' }} className="text-xl text-[#0f1a14] mb-4">No verification of listings</h2>
          ...
          <div className="bg-white border border-[#e2e6ed] rounded-2xl p-8">
            <h2 style={{ fontFamily: 'var(--font-display), sans-serif' }} className="text-xl text-[#0f1a14] mb-4">Not a broker or investment advisor</h2>
          ...
          <div className="bg-white border border-[#e2e6ed] rounded-2xl p-8">
            <h2 style={{ fontFamily: 'var(--font-display), sans-serif' }} className="text-xl text-[#0f1a14] mb-4">Investment risk</h2>
          ...
          <div className="bg-white border border-[#e2e6ed] rounded-2xl p-8">
            <h2 style={{ fontFamily: 'var(--font-display), sans-serif' }} className="text-xl text-[#0f1a14] mb-4">Third-party content</h2>
          ...
          <div className="bg-white border border-[#e2e6ed] rounded-2xl p-8">
            <h2 style={{ fontFamily: 'var(--font-display), sans-serif' }} className="text-xl text-[#0f1a14] mb-4">Limitation of liability</h2>
          ...
          <div className="bg-white border border-[#e2e6ed] rounded-2xl p-8">
            <h2 style={{ fontFamily: 'var(--font-display), sans-serif' }} className="text-xl text-[#0f1a14] mb-4">Contact</h2>
