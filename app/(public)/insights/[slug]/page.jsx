          ...
          <div className="lg:col-span-2 flex flex-col gap-7">
            ...
            <div className="bg-white border border-[#e8eaee] rounded-2xl p-8">
              ...
              {(report.market_value || report.expected_growth) && (
                <div className="flex gap-6 p-4 bg-[#f6f7f9] rounded-xl border border-[#e8eaee] mb-6">
                  {report.market_value && (
                    <div>
                  ...
                  {report.expected_growth && (
                    <div className="border-l border-[#e8eaee] pl-6">
            ...
            {showFull ? (
                  ...
                  <div className="bg-white border border-[#e8eaee] rounded-2xl p-7">
                    ...
                    <div className="flex flex-col gap-5">
                      {keyFindings.map((finding, i) => {
                        ...
                        return (
                          <div key={i} className="flex gap-4 pb-5 border-b border-[#e8eaee] last:border-0 last:pb-0">
                            <div className="w-6 h-6 rounded-full bg-[#f2f4f6] border border-[#c8d8cc] flex items-center justify-center text-[10px] font-mono text-[#2d6a4f] flex-shrink-0 mt-0.5">
                              {i + 1}
                            </div>
                            <div>
                  ...
                  <div className="bg-white border border-[#e8eaee] rounded-2xl p-7">
                    <div className="flex items-center justify-between gap-4 flex-wrap">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-lg bg-[#f2f4f6] border border-[#c8d8cc] flex items-center justify-center">
              ...
              <div className="relative">
                {/* Overlay */}
                <div className="absolute inset-0 z-10 backdrop-blur-sm bg-[#f6f7f9]/80 rounded-2xl flex flex-col items-center justify-center text-center px-6 py-16">
                ...
                <div className="pointer-events-none select-none flex flex-col gap-7">
                  ...
                  <div className="bg-white border border-[#e8eaee] rounded-2xl p-7 h-40" />
                </div>
              </div>
            )}
