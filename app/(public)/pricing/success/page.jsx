...
const PLAN_LABELS = {
  researcher: { name: "Researcher", price: "$9/month" },
  expert: { name: "Expert", price: "$49/month" },
  company: { name: "Company", price: "$99/month" },
  investor: { name: "Investor", price: "$149/month" },
};
  ...
  return (
    <div className="max-w-md w-full text-center">
      ...
      <p className="text-[#718096] text-sm leading-relaxed mb-8">
        Your card will not be charged until <strong>July 15, 2025</strong>. You'll receive a reminder email before then.
      </p>
...
export default function PricingSuccess() {
  return (
    <div className="min-h-screen bg-[#f2f4f8] flex items-center justify-center px-6"
      ...
      <Suspense fallback={<div className="text-sm text-[#718096]">Loading…</div>}>
        <SuccessContent />
      </Suspense>
    </div>
  );
