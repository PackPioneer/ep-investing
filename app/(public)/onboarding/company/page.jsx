...
const SECTORS = ["green_hydrogen","nuclear_technologies","battery_storage","electric_aviation","solar","wind_energy","ev_charging","electric_vehicles","industrial_decarbonization","carbon_credits","direct_air_capture","saf_efuels","geothermal_energy","clean_cooking","grid_storage","grid_monitoring","agtech","maritime_shipping","fintech","information_services","energy_management"];
