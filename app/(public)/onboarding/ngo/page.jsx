...
const SECTORS = [
  "solar", "wind-energy", "battery-storage", "grid-storage", "energy-storage", "green-hydrogen",
  ...
  if (done) return (
    <div className="min-h-screen bg-[#f6f7f9] flex items-center justify-center px-6"
      ...
      <div className="max-w-md text-center">
        ...
        <h2 style={{ fontFamily: 'var(--font-display), sans-serif' }} className="text-3xl text-[#0f1a14] mb-3">Profile under review</h2>
    ...
    <div className="min-h-screen bg-[#f6f7f9] text-[#0f1a14]" style={{ fontFamily: "var(--font-geist-sans), sans-serif" }}>
      <div className="max-w-2xl mx-auto px-6 py-12">
        <div className="text-center mb-10">
          ...
          <h1 style={{ fontFamily: 'var(--font-display), sans-serif' }} className="text-3xl text-[#0f1a14] mb-2">List your organization</h1>
