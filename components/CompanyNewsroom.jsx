      ...
      <div className="flex flex-col">
        {rows.map((a) => (
          <div key={a.id} className="py-2.5 border-b border-[#e8eaee] last:border-0">
            ...
            {a.link_url && (
              <a href={a.link_url} onClick={() => fetch(`/api/announcements/${a.id}/click`, { method: "POST" }).catch(() => {})} target="_blank" rel="noopener noreferrer" className="inline-block mt-1.5 text-[11px] font-semibold bg-[#2d6a4f] text-white px-2.5 py-1 rounded-md hover:bg-[#235a40]">
