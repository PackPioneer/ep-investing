...
export const CAT_LABEL = {
  partnership: "Partnership", raise_open: "Raises", raise_close: "Raises",
...
// Preset button labels for the CTA dropdown (covers every category default).
export const CTA_OPTIONS = [
  "Learn more", "Work with us", "Contact sales", "Request a demo",
  "See open roles", "Investor inquiry", "Partner with us",
  "Get in touch", "Connect with us", "Apply now", "Read more",
];
