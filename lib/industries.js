...
export const INDUSTRIES = [
  ...
  { slug: "grid_monitoring", label: "Grid Monitoring" },
  { slug: "geothermal_energy", label: "Geothermal Energy" },
  { slug: "electric_vehicles", label: "Electric Vehicles" },
  { slug: "agtech", label: "AgTech" },
  { slug: "maritime_shipping", label: "Maritime & Shipping" },
  { slug: "fintech", label: "Financial Technology" },
  { slug: "information_services", label: "Data & Information Services" },
  { slug: "energy_generation", label: "Energy Generation" },
  { slug: "energy_efficiency", label: "Energy Efficiency" },
  { slug: "energy_management", label: "Energy Management" },
];
