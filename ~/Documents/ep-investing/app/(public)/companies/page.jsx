...
const TAG_LABELS = {
  ...
  industrial_decarbonization: "Industrial Decarb",
  nuclear_technologies: "Nuclear",
...
export default function CompaniesPage() {
  ...
  return (
    <div className="bg-white text-slate-900 font-sans">
      ...
      {/* HERO */}
      <section className="relative pt-28 pb-24 px-6 bg-gradient-to-b from-emerald-50/50 to-white">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              <Link href="/investors" className="px-8 py-4 rounded-xl bg-slate-900 text-white font-semibold hover:bg-emerald-600 transition-all shadow-lg shadow-emerald-100 text-center">
                View Investors
              </Link>
              <Link href="/grants" className="px-8 py-4 rounded-xl border border-slate-200 bg-white text-slate-600 font-semibold hover:bg-slate-50 transition text-center">
                View Grants
              </Link>
            </div>
          </motion.div>
                  ...
                  <div className="pt-6 border-t border-slate-50 flex items-center justify-between">
                    ...
                    {company.url && (
                      <a
                        ...
                        className="text-sm font-bold text-slate-900 flex items-center gap-1 hover:gap-2 transition-all hover:text-emerald-600"
                      >
      ...
      <section className="py-24 px-4 sm:px-6 bg-slate-950 text-white overflow-hidden relative">
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <FeatureCard icon={<Zap size={24} />} title="Talent Pool" desc="Access a database of engineers and operators specifically looking for mission-driven work." />
            <FeatureCard icon={<Layers size={24} />} title="Resource Library" desc="Standardized legal docs, pitch decks, and commercialization playbooks for founders." />
            <FeatureCard icon={<Search size={24} />} title="Visibility" desc="Get featured in our monthly investor newsletter sent to 500+ climate-focused VCs." />
          </div>
        </div>
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full bg-[radial-gradient(circle_at_center,_var(--tw-gradient-from)_0%,transparent_70%)] from-emerald-500/10 to-transparent pointer-events-none" />
      </section>
